...
export default dummy = [
  {
    ...
    projectLength: 239,
    projectImageLink: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/Yawning_horse%2C_Scotland.jpg/640px-Yawning_horse%2C_Scotland.jpg'
  },
  {
    ...
    postSaved: false,
    postText:
      'hi frieeeeends im a rabbit and this my first track boom. #haymama #first',
    tags: ['haymama', 'first'],
    projectAudioLink:
  ...
  },
  {
    ...
    postSaved: false,
    postText:
      'I have been waiting to release this for so long. pls no hate thx. #meow',
    tags: ['meow'],
    projectAudioLink:
