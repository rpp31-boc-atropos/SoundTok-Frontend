...
export default dummy = [
  ...
  },
  {
    ...
    projectTitle: 'elo',
    projectLength: 98,
    projectImageLink: 'https://e.snmc.io/i/600/s/949d0daf3ee48d06660a2e6011872a80/2405912',
    tracks: []
  },
  {
    postId: 3,
    ...
    isDraft: false,
    postText:
      'i got my fav bugs yesterday, so today the #inspiration hit',
    tags: [{'#inspiration': 42}],
    projectAudioLink:
      'https://files.freemusicarchive.org/storage-freemusicarchive-org/music/ccCommunity/Kai_Engel/Satin/Kai_Engel_-_03_-_Contention.mp3',
  ...
  },
  {
    ...
    projectAudioLink:
      'https://files.freemusicarchive.org/storage-freemusicarchive-org/music/ccCommunity/Kai_Engel/Satin/Kai_Engel_-_01_-_Augmentations.mp3',
    projectTitle: 'swimming in the breeze',
    projectLength: 283,
    projectImageLink: 'https://dspncdn.com/a1/media/692x/7b/44/1a/7b441af9d3dcf5682cb5f93c486617e4.jpg',
    tracks: []
  },
  {
    postId: 1,
